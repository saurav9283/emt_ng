...
const { _npfl_getRandomWelcomeQuestion, _npfl_insertUserPoints, _npfl_handelSms, _npfl_insertIntoUserAnswerLogs, _npfl_insertIntoTableAnswer, _npfl_compareAnswers, _npfl_updateAnswersLogs, _npfl_checkPendingAnswersLog, _npfl_upadteUserPoints, _npfl_checkExistingPoints, _npfl_insertUserAllLogs, _npfl_deleteFormTblAnsLogs } = require("./npfl.football.services");
